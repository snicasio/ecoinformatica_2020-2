...
row.names(ind_tab) = seq(rownames(ind_tab))  # Es solo para estetica
...
ind_tab[,c("bio", "chlred_edge", "mcari", "msi")] = log10(ind_tab[,c("bio", "chlred_edge", "mcari", "msi")])
...
abline(h=mean(ind_tab$bio), v=0, lty = 2, lwd= 2, col= "darkgreen")
